        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.promos.store') }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="title" class="form-control" value="{{ old('title') }}" placeholder="Contoh: Promo Cashback 20%" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <span style="font-size: 11px; color: var(--text-3); display: block; margin-top: 4px;">Format: jpeg, jpg, png. Ukuran maks: 2MB. Kosongkan jika ingin menggunakan gambar default.</span>
                </div>

                <div class="form-group">
                    <label class="checkbox-wrap">
                        <input type="checkbox" name="is_active" value="1" {{ old('is_active', 1) ? 'checked' : '' }}>
                        Aktifkan Promo ini langsung
                    </label>
                </div>
