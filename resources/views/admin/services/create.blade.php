...
<form method="POST" action="{{ route('admin.services.store') }}">
    ...
    <div class="form-group"><label class="form-label">Harga Satuan (Rp)</label><input type="number" name="price_per_kg" class="form-control" value="{{ old('price_per_kg') }}" min="100" required></div>
